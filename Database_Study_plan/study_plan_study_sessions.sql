...
CREATE TABLE `study_sessions` (
  ...
  `status` enum('scheduled','in_progress','completed','cancelled','missed') COLLATE utf8mb4_unicode_ci DEFAULT 'scheduled',
  ...
  CONSTRAINT `study_sessions_ibfk_2` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`subject_id`) ON DELETE SET NULL,
  CONSTRAINT `study_sessions_chk_1` CHECK ((`focus_score` between 1 and 10))
