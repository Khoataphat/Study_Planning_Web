...
CREATE TABLE `tasks` (
  ...
  `task_type` enum('study','review','practice','project','exam') COLLATE utf8mb4_unicode_ci DEFAULT 'study',
  ...
  CONSTRAINT `tasks_ibfk_2` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`subject_id`) ON DELETE SET NULL
