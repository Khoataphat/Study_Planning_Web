...
CREATE TABLE `ml_recommendations` (
  ...
  `recommendation_type` enum('subject','study_time','break','review','challenge') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  CONSTRAINT `ml_recommendations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
LOCK TABLES `ml_recommendations` WRITE;
/*!40000 ALTER TABLE `ml_recommendations` DISABLE KEYS */;
/*!40000 ALTER TABLE `ml_recommendations` ENABLE KEYS */;
UNLOCK TABLES;
