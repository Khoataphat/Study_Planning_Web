...
public class UserProfilesDAO {
    ...
    public void updateSetup(UserProfiles info) throws Exception {
        ...
        try (Connection con = DBUtil.getConnection(); 
            ...
            if (rowsAffected == 0) {
                // Nếu không có bản ghi nào được cập nhật, có thể user chưa có profile
                // Trong trường hợp này, chúng ta sẽ tạo mới
                saveSetup(info);
            }
            
        } catch (Exception e) {
            System.err.println("Lỗi khi cập nhật UserProfiles: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
    ...
    public boolean profileExists(int userId) throws Exception {
        ...
        try (Connection con = DBUtil.getConnection(); 
            ...
            System.err.println("Lỗi khi kiểm tra tồn tại profile: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return false;
    ...
    public void deleteProfile(int userId) throws Exception {
        ...
        try (Connection con = DBUtil.getConnection(); 
            ...
            System.err.println("Lỗi khi xóa UserProfiles: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
