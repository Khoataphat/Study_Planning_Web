...
import com.studyplanning.model.UserSchedule;
import com.studyplanning.service.ScheduleService;
import com.studyplanning.utils.JsonUtil;
import com.studyplanning.utils.ValidationUtil;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Gson gson = new com.google.gson.GsonBuilder()
                .registerTypeAdapter(java.sql.Time.class, new com.studyplanning.utils.SqlTimeDeserializer())
                .create();
